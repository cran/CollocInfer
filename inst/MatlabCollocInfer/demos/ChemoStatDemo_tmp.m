...
%  The layers of functions are:
%  1. proc                ... SSE: evaluate integral of square errors
%  2. proc.more           ... findif: estimate derivatives by differences
%  3. proc.more.more      ... logtrans: exponentiate RHS values
%  4. proc.more.more.more ... chemo_fun: compute values of RHS
...
%  The layers of functions are:
%  1. lik                ... logstate: evaluate sum of square errors for 
%                            log data
%  2. lik.more           ... genlin: evaluate two sums of variables
%  3. lik.more.more      ... logtrans: exponentiate RHS values
%  4. lik.more.more.more ... chemo_fun: compute values of RHS
...
lik.bvals              = bvals_obs;
lik.more               = make_SSElik;
lik.more.more          = make_genlin;
lik.more.more.weights  = [100,1];
lik.more.more.more.mat = zeros(2,5);
lik.more.more.more.sub = [1,2,1; ...
                          1,3,1; ...
                          2,4,2; ...
                          2,5,2];
...
[f, grad, d2fdc2, d2fdcdp, gdata, geqtn] = ...
    SplineCoefs(coefs0, ChemoTime, ChemoData, logpars, lik, proc);
...
[f, grad, d2fdc2, d2fdcdp, gdata, geqtn] = ...
    SplineCoefs(coefs1, ChemoTime, ChemoData, logpars, lik, proc);
grad = reshape(grad,nbasis,5); 
