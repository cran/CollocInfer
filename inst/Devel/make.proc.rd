...
\item{make.RSK2proc}{ calculates the order-2 stochastic Runge-Kutta penalty to provide higher-order numerical
...
For \code{Cproc} and \code{Dproc} this should specify the distribution; for \code{SSEproc} and \code{SRK2proc} it
should specify the right hand side of a differential equation. 
}
\seealso{LS.setup, multinorm.setup, SRK2.setup}
\examples{
