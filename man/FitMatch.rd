...
\item{FitMatchDC}{The derivative fo \code{FitMatchErr} with respect to the elements \code{coefs} for the states being estimated.}
\item{FitMatchDC2}{The second derivative fo \code{FitMatchErr} with respect to the elements \code{coefs} for the states being estimated.}
...
\seealso{ParsMatchErr, SplineCoefsErr, inneropt}
\examples{
###############################
#### Some Data            #####
###############################
